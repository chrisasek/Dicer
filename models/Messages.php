...
class Messages
{
	...
	//message constants
	const SITE_URL = 'https://marketingpros.ng/',
		ADMIN_EMAIL = 'info@marketingpros.ng',
		SUPPORT_EMAIL = 'support@marketingpros.ng',
		MAIN_EMAIL = 'marketingprosltd@gmail.com';
				...
				<div class='offset-by-two eight columns' style='margin-top: 5%;'>
					<div class='card' style='background:#fff;border-radius:.8rem;border:0;'>
						<div class='card-body' style='padding:2rem 1.6rem;'>
							<img src='https://marketingpros.ng/media/images/marketing-pros-logo.png' class='card-cover' style='max-width:150px'>
							<br>
							<br>
							<br>
	...
	public static function newAccount($name, $email = null, $url = "https://marketingpros.ng/")
	{
		$message = "<p style='font-size: 1.1rem;'>Were sending this email to confirm that your account at Marketingpros was created successfully.</p>
                    ...
                    <p style='font-size: 1.1rem;'>We hope you will be happy with products offered by marketingpros.ng and that you will shop with us again
                        and
                        again.</p>
	...
	public static function sendMessage($user_id, $snippet_id, $subject, $message)
	{
		$fields = array(
			'user_id' => $user_id,
	...
	public function sendNotification($fields = array())
	{
	...
	public static function sendSMS($mobiles = "2348030000000", $message = "This is a test message", $sender = "MarketingPros")
	{
		...
		$data = array('api_token' => 'ytvF31ebUa3y5weFOf1XKSWcbkzzHS3IAukdyvG2YEoGrTIYptnqtBYiAkLn', 'to' => $mobiles, 'from' => $sender, 'body' => strip_tags($message), 'dnd' => 2);
	...
	public static function sendSMSNBS($mobiles = "2348030000000", $message = "This is a test message", $sender = "M-Pros")
	{
		...
		// $mobiles  = '2348030000000';
		// Set your domain's API URL
		$username = 'marketingprosltd@gmail.com';
