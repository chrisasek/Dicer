			...
			switch (Input::get('req')) {
				case "fund-account":
					try {
						...
						$uwallet = $user->getWallet($data['uid']);
						$nbal = $uwallet->bal + $amount;
						...
						if (empty($errors)) {
							...
							echo json_encode(array('success' => true, 'message' => "Account Funded successful, your transaction reference is: {$data['ref']}. Thank you."));
							exit;
						}
					} catch (Exception $e) {
						$errors[] = $e->getMessage();
